...
export default function Dashboard() {
  ...
  return (
    <>
      <Meta title="HelloPortfol.io | Retirement Calculator" />
      <div className="center" style={{ marginBottom: "3rem" }}>
          ...
          <div className={styles.inputForm}>
            ...
            <div className={styles.row}>
              <label className="tooltip">
                Withdrawal Rate:
                <span className="tooltiptext">
                  How much you remove from your assets each year. Standard is
                  4%.
                </span>
              </label>
              <span className={styles.postInput}>%</span>
        ...
        <div className={`row ${styles.outputs}`}>
          <div className="item">
            You need{" "}
            <b className="green">{toLocaleFixed(outputs.retireNumb)}</b> to
            retire.
            <br />
            {outputs.numbYears <= 0 ? (
              `You have that today!`
